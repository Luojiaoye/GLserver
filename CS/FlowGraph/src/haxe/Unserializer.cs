...
namespace haxe._Unserializer {
	public class DefaultResolver : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_haxe__Unserializer_DefaultResolver(global::haxe._Unserializer.DefaultResolver __hx_this) {
		}
	...
	public class Unserializer : global::haxe.lang.HxObject {
		...
		public static global::Array<int> initCodes() {
			unchecked {
				...
				{
					int _g1 = 0;
					int _g = global::haxe.Unserializer.BASE64.Length;
					while (( _g1 < _g )) {
						int i = _g1++;
		...
		public virtual void unserializeObject(object o) {
			unchecked {
				while (true) {
					...
					string k = global::haxe.lang.Runtime.toString(this.unserialize());
					if ( ! (( k is string )) ) {
						throw global::haxe.lang.HaxeException.wrap("Invalid object key");
					}
					
					object v = this.unserialize();
					global::Reflect.setField(o, k, v);
				}
		...
		public virtual object unserializeEnum(global::System.Type edecl, string tag) {
			unchecked {
				int p = this.pos++;
				string s = this.buf;
				...
				if (( nargs == 0 )) {
					return global::Type.createEnum<object>(((global::System.Type) (edecl) ), ((string) (tag) ), default(global::Array));
				}
				
				global::Array args = new global::Array<object>();
				while (( nargs-- > 0 )) {
					global::haxe.lang.Runtime.callField(args, "push", 1247875546, new global::Array<object>(new object[]{this.unserialize()}));
				}
				
				return global::Type.createEnum<object>(((global::System.Type) (edecl) ), ((string) (tag) ), ((global::Array) (args) ));
			}
		}
		...
		public override object __hx_invokeField(string field, int hash, global::Array dynargs) {
			unchecked {
				switch (hash) {
					...
					case 2131770120:
					{
						return this.unserializeEnum(((global::System.Type) (dynargs[0]) ), global::haxe.lang.Runtime.toString(dynargs[1]));
					}
